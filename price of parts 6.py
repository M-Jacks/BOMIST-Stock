...
# Fetch parts from BOMIST API with error handling
try:
...
# Define starting row and column indexes
starting_row_index = 2  # Assuming row 1 is for headers
start_col_index = 'a'
...
for i in range(0, len(parts_data), batch_size):
    ...
    for part_entry in batch:
        ...
        if inventory == 0:
            ...
            sheet.update_value(f'K{starting_row_index}', "No stock")
